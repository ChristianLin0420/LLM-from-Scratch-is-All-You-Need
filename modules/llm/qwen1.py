...
class Qwen1(nn.Module):
    ...
    Args:
        config (dict): Configuration dictionary with the following keys:
            ...
            - (Other keys required by Qwen1Block and RMSNorm.)
    ...
    def __init__(self, config):
        ...
        self.blocks = nn.ModuleList([Qwen1Block(config) for _ in range(config["num_layers"])])
    ...
    def forward(self, input_ids):
        """
        Forward pass of the Qwen1 model.
